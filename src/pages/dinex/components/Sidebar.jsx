...
export const Sidebar = () => {
    ...
    return (
        <div className="element">
            ...
            <div className="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-[#242A2E]">
                <div className="flex justify-start mb-4">
                    <button
                        type="button"
                        className="inline-flex items-center justify-center p-2 rounded-md dark-button"
                    >
                        <svg
                        className="w-6 h-6"
                        fill="none"
                ...
                <ul className="space-y-2 font-medium">
                    <li>
                        <a href="#" className="flex items-center gap-7 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a
                            href="#"
                            className="flex items-center gap-7 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                            <span className="flex items-center justify-center w-5 h-5">
                    ...
                    {/* <li>
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">Ahorros</span>
                ...
                <div className="flex items-center gap-4 mt-4">
                    <label className="inline-flex items-center cursor-pointer">
                        ...
                        <div className="relative w-11 h-6 bg-gray-200 rounded-full dark:bg-gray-700 transition-colors duration-300 ease-in-out">
                            ...
                            >
                            {isDark ? <span className="text-white">🌙</span> : <span className="text-yellow-500">☀️</span>}
                            </div>
                        </div>
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Tema: Claro</span>
                    </label>
                </div>
            </div>
            </aside>

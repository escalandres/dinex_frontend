    ...
    return (
        <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Sidebar />
                <a href="/dinex" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="/icons/logo.png" className="h-8" alt="Flowbite Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Dinex</span>
                </a>
